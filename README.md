...
cobalt-ui-table-line is a Lua project for frontend apps. It focuses on this technical goal: Develop a Lua command-oriented project for table scenarios with transition tables, invalid-transition tests, and offline replay mode.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 154, risk penalty 5, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
