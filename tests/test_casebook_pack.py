"""Regression checks for the cobalt-ui-table-line casebook."""
...
from casebook.harness import assert_expected, cobalt_ui_table_line_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_ui_table_line_summary(), assert_expected())
