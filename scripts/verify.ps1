...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt-ui-table-detail.ps1

lua tests/test_domain_review.lua

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt-ui-table-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt-ui-table-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt_ui_table_line-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
