...
`cobalt-ui-table-line` is centered on frontend apps work in Lua. The technical target is: Develop a Lua command-oriented project for table scenarios with transition tables, invalid-transition tests, and offline replay mode.
...
The score is deterministic. The current threshold is 154. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 6.
